...
// 初始化片选引脚，使用硬件 SPI 片选
      GPIO_InitStruct.Pin 		   = GPIO_PIN_15;                // CS引脚
      GPIO_InitStruct.Mode 		= GPIO_MODE_AF_PP;            // 复用推挽输出
      GPIO_InitStruct.Pull 		= GPIO_NOPULL;                // 无上下拉
      GPIO_InitStruct.Speed 		= GPIO_SPEED_FREQ_VERY_HIGH;  // 最高速度等级
      GPIO_InitStruct.Alternate  = GPIO_AF7_SPI6;              // 复用到SPI6，复用线7
      HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

// 初始化 SCK、MISO、MOSI
      GPIO_InitStruct.Pin 		   = GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5;    // SCK、MISO、MOSI 引脚
      GPIO_InitStruct.Mode 		= GPIO_MODE_AF_PP;                     // 复用推挽输出
      GPIO_InitStruct.Pull 		= GPIO_NOPULL;                         // 无上下拉
      GPIO_InitStruct.Speed 		= GPIO_SPEED_FREQ_VERY_HIGH;           // 最高速度等级
      GPIO_InitStruct.Alternate  = GPIO_AF8_SPI6;                       // 复用到SPI6，复用线8
